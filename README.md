...
* The zoom value is tied to the original image, not each image output. Thus the chosen value does not carry as much weight as it should, if any. (neural-zoom-test.sh should hopefully fix this problem)
